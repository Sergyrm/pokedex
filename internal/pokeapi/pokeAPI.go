...
func (c *Client) GetPokemonByLocation(pageURL *string, locationArea string) (LocationDetails, error) {
...
func (c *Client) GetPokemonInfo(pageURL *string, pokemonName string) (Pokemon, error) {
